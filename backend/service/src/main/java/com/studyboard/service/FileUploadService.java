...
public interface FileUploadService {
  ...
  /**
   * Stores file in the storage and creates a matching document for this file If a user file does
  ...
  /**
   * Thread safe version of the store function Separates file into name and content and saves them
   * in-memory to avoid loss of multipart-file resources
   *
